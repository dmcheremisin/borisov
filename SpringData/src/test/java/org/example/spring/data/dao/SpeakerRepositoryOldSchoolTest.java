...
@Transactional
public class SpeakerRepositoryOldSchoolTest extends BaseTest {

    @Autowired
    private SpeakerRepositoryOldSchool speakerRepositoryOldSchool;
    ...
    public void setUp() {
        ...
        speakerRepositoryOldSchool.save(Arrays.asList(dmitriiCheremisin, markCheremisin));
    }

    @Test
    public void testCount() {
        System.out.println("----- Number of speakers TEST -----");
        System.out.println("Speakers count: " + speakerRepositoryOldSchool.count());
        assertEquals(2, speakerRepositoryOldSchool.count());
        System.out.println("-----------------------------------");
    }
    ...
    public void testFindAll() {
        ...
        List<Speaker> allSpeaker = speakerRepositoryOldSchool.getAllSpeaker();
    ...
    public void testFindByName() {
        ...
        Speaker speaker = speakerRepositoryOldSchool.findByName("Dmitrii Cheremisin").get(0);
    ...
    @After
    public void clean() {
        speakerRepositoryOldSchool.deleteAll();
    }
}
